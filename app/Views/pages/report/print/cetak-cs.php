...
<body>
 ...
 <body>
  <div id="page-wrap">
   <textarea id="header">Kartu Stok</textarea>
   ...
   <table id="items">
        ...
        <?php foreach($items as $key => $data) { ?> 
            <tr class="item-row">
                <td class="cost"><?= $data->date ?></td>
                <td class="qty"><?= $data->information ?></td>
                <td class="qty"><?= $data->stock_in ?></td>
                <td class="qty"><?= $data->stock_out ?></td>
                <td class="qty"><?= $data->saldo ?></td>
            </tr>
        <?php } ?>
   </table>
